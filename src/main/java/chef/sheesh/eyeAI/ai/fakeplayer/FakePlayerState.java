 ...
 */
public enum FakePlayerState implements List<Player> {
    IDLE,
    MOVING,
    COMBAT,
    ATTACKING,
     ...
     *
     * @param player element to be appended to this list
     ...
     */
    @Override
    public @NotNull ListIterator<Player> listIterator() {
        return null;
    }
     ...
     */
    @Override
    public @NotNull ListIterator<Player> listIterator(int index) {
        return null;
    }
     ...
     */
    @Override
    public @NotNull List<Player> subList(int fromIndex, int toIndex) {
        return List.of();
    }
}
